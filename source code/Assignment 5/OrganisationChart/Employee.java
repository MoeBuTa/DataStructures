...
public class Employee {
    ...
    public void addToTeam(Employee empl){
        if (empl == null) return;
        /*# YOUR CODE HERE */
        if(empl.initials == null || empl.role == null) return;
        this.team.add(empl);
    ...
    public void removeFromTeam(Employee empl){
        /*# YOUR CODE HERE */
    	if(empl.getManager() != null) {
    		empl.getManager().team.remove(empl);
    	}
    ...
    public String getRole() {return role;} //returns the role of the employee
    
    public String getInitials() {return initials;} //returns the initial of the employee 
    
    public double getOffset() {return offset;} //returns the offset of the employee
    ...
    //if the new person don't have an initial, change the role of the target
    public void changeRole(Employee emp) {
    	if(emp.initials == null && emp.role != null) {
    		this.role = emp.role;
    	}
